...
// worker.js
var OASA = "https://telematics.oasa.gr/api/";
var AIRPORT_STOPS = ["10705", "440103"];
var ROUTES = { "2051": 1, "3028": 1, "5373": 1, "5675": 1 };
async function airport() {
  const seen = /* @__PURE__ */ new Set(), byRoute = {};
...
var worker_default = {
  async fetch(request, env) {
    try {
      ...
      if (url.pathname === "/api/x95") {
        const d = await airport();
        const mins = d.routes["2051"] || [];
        return json({ live: mins.length > 0, mins: mins.slice(0, 4), ts: d.ts });
      }
    } catch (e) {
    }
...
// .wrangler/tmp/bundle-FGciP9/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-FGciP9/middleware-loader.entry.ts
